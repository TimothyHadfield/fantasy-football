...
**Over 11,000 assertions in all, across 34 suites.** A full run at the end of
2026-09-17 was green in about 340 seconds, and GitHub Actions runs `npm test`
