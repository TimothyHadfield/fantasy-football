...
**Over 10,000 assertions in all, across 31 suites.** A full run at the end of
2026-09-17 was green in about 275 seconds, and GitHub Actions runs `npm test`
