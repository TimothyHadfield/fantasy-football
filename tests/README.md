...
**11,598 assertions across 35 suites**, counted off a green run on 2026-09-19
(about 6-8 minutes depending on what else the machine is doing). Four of the
35 report pages or scenarios rather than a count, so they are not in that
